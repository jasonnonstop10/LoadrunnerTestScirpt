...
Action()
{
	...
	lr_end_transaction("TicketPurchase_02_FindFlight",2);
	...
	lr_end_transaction("TicketPurchase_03_SelectFlight",2);
	...
	lr_end_transaction("TicketPurchase_04_paymentDetails",2);
	...
	lr_end_transaction("TicketPurchase_05_logout",2);
