# 1 "c:\\users\\lenovo\\documents\\github\\loadrunnertestscirpt\\ex7\\tianwit_exercise_7_webtour\\\\combined_Tianwit_exercise_7_WebTour.c"
...
# 1 "c:\\users\\lenovo\\documents\\github\\loadrunnertestscirpt\\ex7\\tianwit_exercise_7_webtour\\\\combined_Tianwit_exercise_7_WebTour.c" 2
...
# 2 "c:\\users\\lenovo\\documents\\github\\loadrunnertestscirpt\\ex7\\tianwit_exercise_7_webtour\\\\combined_Tianwit_exercise_7_WebTour.c" 2
...
# 3 "c:\\users\\lenovo\\documents\\github\\loadrunnertestscirpt\\ex7\\tianwit_exercise_7_webtour\\\\combined_Tianwit_exercise_7_WebTour.c" 2
...
# 4 "c:\\users\\lenovo\\documents\\github\\loadrunnertestscirpt\\ex7\\tianwit_exercise_7_webtour\\\\combined_Tianwit_exercise_7_WebTour.c" 2
...
BookFlight()
{
	...
	lr_end_transaction("BookFlight_00_FirstPage",2);
	...
	lr_end_transaction("BookFlight_01_LogIn",2);
	...
	lr_end_transaction("BookFlight_02_SelectFlightsButton",2);
	...
	lr_end_transaction("BookFlight_03_FindFlight",2);
	...
	lr_end_transaction("BookFlight_04_SelectFlight",2);
	...
	lr_end_transaction("BookFlight_05_PaymentDetails",2);
	...
	lr_end_transaction("BookFlight_06_SignOff",2);

	return 0;
}
# 5 "c:\\users\\lenovo\\documents\\github\\loadrunnertestscirpt\\ex7\\tianwit_exercise_7_webtour\\\\combined_Tianwit_exercise_7_WebTour.c" 2
...
Itinerary()
{
	...
	lr_end_transaction("Itinerary_00_FirstPage",2);
	...
	lr_end_transaction("Itinerary_01_Login",2);
	...
	lr_end_transaction("Itinerary_02_SelectItineraryButton",2);
	...
	lr_end_transaction("Itinerary_03_SignOff",2);

	return 0;
}
# 6 "c:\\users\\lenovo\\documents\\github\\loadrunnertestscirpt\\ex7\\tianwit_exercise_7_webtour\\\\combined_Tianwit_exercise_7_WebTour.c" 2
...
RegisterUser()
{
	...
	web_url("index.htm", 
		...
		"Mode=HTML", 
		"LAST");
    lr_end_transaction("RegisterUser_00_FirstPage",2);
	...
	lr_end_transaction("RegisterUser_01_ClickSignUpNowLink",2);
	...
	lr_end_transaction("RegisterUser_02_CustomerProfile",2);
...
# 7 "c:\\users\\lenovo\\documents\\github\\loadrunnertestscirpt\\ex7\\tianwit_exercise_7_webtour\\\\combined_Tianwit_exercise_7_WebTour.c" 2
...
# 8 "c:\\users\\lenovo\\documents\\github\\loadrunnertestscirpt\\ex7\\tianwit_exercise_7_webtour\\\\combined_Tianwit_exercise_7_WebTour.c" 2
